...
pub const INSTRS: [InstrInfo; 256] = [
    ...
    InstrInfo{instr: 0x10, name: "call", in_type: Prim::Void, out_type: Prim::Func, has_const: true, takes_align: false},
    ...
    InstrInfo{instr: 0xd2, name: "ref.func", in_type: Prim::Void, out_type: Prim::Func, has_const: true, takes_align: false},
